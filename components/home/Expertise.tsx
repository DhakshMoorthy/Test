      ...
      <div className="mx-auto max-w-6xl px-6 py-20 sm:px-8 sm:py-28">
        ...
        <div className="mb-16 grid gap-6 md:grid-cols-3 md:gap-8">
          {EXPERTISE.cards.map((card, i) => (
            ...
            >
              <span className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl border border-[#0a0a0a]/8 bg-[#fafafa] text-[#141414] transition-colors group-hover:border-[#E8A000]/30 group-hover:text-[#E8A000]">
            ...
            <ul className="m-0 list-none space-y-4 p-0">
              {EXPERTISE.checklist.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[#0a0a0a]/10 bg-[#fafafa] text-[#E8A000]">
                    <CheckIcon />
                  </span>
